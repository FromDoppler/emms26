<section class="centralvideo hidden--vip">
    <div class="centralvideo__head">
        <h2 class="centralvideo-title">¡Obtén tu entrada VIP antes de que suba el precio!</h2>
    </div>
    <div class="emms__container--lg reverse-mb">
        <ul class="centralvideo__list centralvideo__list--live emms__fade-in">
            <p class="centralvideo__list-title">Compra tu entrada VIP sólo si…</p>
            ...
            <li>Te gustaría resolver dudas de tu negocio, uno a uno, con un referente del Marketing.</li>
