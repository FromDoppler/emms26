...
class CheckoutProviderRejectionCatalog
{
    ...
    {
        return $providerCode === null ? null : (self::CATEGORIES[$providerCode] ?? null);
    }

    public static function isBusinessRejection(?string $providerCode): bool
    {
        return self::categoryFor($providerCode) !== null;
    }
