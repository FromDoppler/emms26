<?php if ($isRegistered) { ?>
  <title>Llega el EMMS 2026: el evento online de Marketing y Comercio Electrónico.</title>

  <meta name="title" content="Llega el EMMS 2026: el evento online de Marketing y Comercio Electrónico.">
  <meta name="description" content="¡Cuenta regresiva para el evento más esperado del año! Prepárate para capacitarte con referentes de la industria.">
...
<?php } else { ?>
  <title>Regístrate gratis al EMMS 2026, el evento online de Marketing y Comercio Electrónico.</title>

  <meta name="title" content="Regístrate gratis al EMMS 2026, el evento online de Marketing y Comercio Electrónico.">
  <meta name="description" content="Inscríbete gratis y accede en un solo lugar a todas las tendencias del Marketing Digital y E-commerce.">
