<section class="vip-offer" aria-labelledby="vip-offer-title">
  <div class="vip-offer__container">
    <div class="vip-offer__content">
      <h2 class="vip-offer__title" id="vip-offer-title">
        Regístrate hoy y obtén
    ...
    <div class="vip-offer__visual" aria-hidden="true">
      <img class="vip-offer__image" src="/src/img/vip-offer-girl-ticket.png" alt="Disfruta de ser VIP" loading="lazy" />
    </div>
  </div>
</section>
