...
$faqItems = [
    ...
    [
        ...
        "answer" => "El EMMS 2025 tiene 2 ediciones: E-commerce, que tendrá lugar el 28 y 29 de abril de 2025 y Digital Trends, en octubre próximo (fecha a definir). Registrándote al evento recibirás por Email todos las novedades."
    ],
    [
    ...
    [
        ...
        "answer" => "Por ahora, puedes registrarte de forma gratuita en el EMMS E-commerce 2025, que tendrá lugar en abril de 2025. Cuando se acerque la fecha del EMMS E-commerce 2025, te avisaremos por Email para que no te pierdas nada :)"
    ],
    [
    ...
    [
        ...
        "answer" => "Las Conferencias de las ediciones pasadas están grabadas y puedes acceder a ellas desde aquí."
    ],
    [
        "question" => "🤔 Me apunté al evento y aún no recibí el Email de confirmación, ¿qué hago?",
        "answer" => "Comunícate con el equipo de Atención al Cliente de Doppler enviando un Email a soporte@fromdoppler.com para ayudarte a resolverlo."
    ],
    [
        "question" => "📣 Me interesa ser aliado en el evento, ¿todavía estoy a tiempo de sumarme?",
        "answer" => "¡Sí claro! Comunícate al Email partners@fromdoppler.com para que podamos contarte cuáles son las oportunidades de participar y cómo podrías sumarte."
    ],
    [
        "question" => "🎙Quiero ser speaker del EMMS, ¿puedo postularme?",
        "answer" => "¡Por supuesto! Escríbenos a partners@fromdoppler.com para comentarnos por qué deberías ser ponente en EMMS y te responderemos a la brevedad."
    ],
    [
        "question" => "📝 ¿Obtengo un certificado de participación por asistir al evento?",
        "answer" => "¡Sí! Podrás descargar tu certificado de asistencia a cada una de las ediciones del EMMS. ¿Tuviste problemas para obtener tu certificado para la edición E-commerce? No te preocupes, contáctanos a soporte@fromdoppler.com y te ayudaremos con ello en breve."
    ]
];
