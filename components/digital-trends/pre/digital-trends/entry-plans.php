  ...
  <div class="emms__plans  hidden--vip" id="entradas">
    <div class="emms__container--lg">
      <div class="emms__plans__title">
        ...
        <p style="font-weight: 600;">Compra tu entrada y accede a: Workshops con certificado, Recursos descargables y una cuenta en Doppler, valorada en hasta USD 500, para implementar gratis tu estrategia de Marketing en todos tus canales. Tu pase cuesta sólo <span>USD <?= VIP_PRICE_CURRENT ?></span>. ¡Se paga solo!</p>
      </div>
